package com.luodong.slibrary.manager;
...
{
    private static SActivityManager sInstance;
    ...
    public static SActivityManager getInstance()
    {
        if (sInstance == null)
        {
            ...
            {
                if (sInstance == null)
                    sInstance = new SActivityManager();
            }
        }
        return sInstance;
    }
    ...
    private final Application.ActivityLifecycleCallbacks mActivityLifecycleCallbacks = new Application.ActivityLifecycleCallbacks()
    {
        ...
        public void onActivityResumed(Activity activity)
        {
            ...
            {
                if (mIsDebug)
                    Log.e(SActivityManager.class.getSimpleName(), "start order activity " + activity + " old index " + index);

                removeActivity(activity);
                addActivity(activity);

                if (mIsDebug)
                    Log.e(SActivityManager.class.getSimpleName(), "end order activity " + activity + " new index " + mActivityHolder.indexOf(activity));
            }
        }
    ...
    private void addActivity(Activity activity)
    {
        ...
        if (mIsDebug)
            Log.i(SActivityManager.class.getSimpleName(), "+++++ " + activity + "\n" + getCurrentStack());
    }
    ...
    private void removeActivity(Activity activity)
    {
        ...
        {
            if (mIsDebug)
                Log.e(SActivityManager.class.getSimpleName(), "----- " + activity + "\n" + getCurrentStack());
        }
    }
