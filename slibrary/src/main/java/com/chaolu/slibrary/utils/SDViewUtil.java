package com.chaolu.slibrary.utils;
...
import com.chaolu.slibrary.SLibrary;
import com.chaolu.slibrary.manager.SDHandlerManager;
...
public class SDViewUtil
{
    ...
    public static Context getApplication(){
        return SLibrary.getInstance().getContext();
    }
    ...
    {
        view.setBackgroundColor(getApplication().getResources().getColor(resId));
    }

    public static void setTextViewColorResId(TextView textView, int resId)
    {
        textView.setTextColor(getApplication().getResources().getColor(resId));
    }
    ...
    @SuppressLint("NewApi")
    public static void scrollToViewY(final NestedScrollView sv, final int y, int delay)
    {
        if (sv != null && delay >= 0)
        {
            if (Build.VERSION.SDK_INT >= VERSION_CODES.HONEYCOMB)
    ...
    {
        return getApplication().getResources().getDisplayMetrics().scaledDensity;
    }
    ...
    {
        hideInputMethod(view, getApplication());
    }
    ...
    {
        showInputMethod(view, getApplication(), 0);
    }

    public static void showInputMethod(View view, long delay)
    {
        showInputMethod(view, getApplication(), delay);
    }
...
//                    {
//                        com.xinfu.library.utils.SToast.showToast(noData);
//                    }
//                    listOriginalData.clear();
//                } else
//                {
...
//                    {
//                        com.xinfu.library.utils.SToast.showToast(noMoreData);
//                    }
//                }
//            }
//        }
//    }
    ...
    {
        LinearLayout linAll = new LinearLayout(getApplication());
...
//    }
    ...
    public static int getIdentifierDrawable(String name)
    {
        ...
        try
        {
            id = getApplication().getResources().getIdentifier(name, "drawable", getApplication().getPackageName());
        } catch (Exception e)
        {
            e.printStackTrace();
        }
